...
public class GMailUtils {
	...
	public static void main(String...args){
		try{
			Gmail service = GoogleAuth.getGmailService();
			MimeMessage emailContent = createEmail("n.d.thang1987@gmail.com", "subject", "bodyText");
	...
	public static Message sendMessage(Gmail service, MimeMessage emailContent)
		...
		return sendMessage(service, GoogleConstant.USER_ID_DEFAULT, emailContent);
	}
