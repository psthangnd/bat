...
public class Task1ScheduleWriteToGSheet{
	private static final String GROUP_NAME = "WRITE_GSHEET";
	
	
	public Task1ScheduleWriteToGSheet() {
		...
		try{
			...
			JobDetail jobDetail = jobBuilder
					.usingJobData("example", "cowell.vn.service.Task1Scheduler")
	...
	public static Trigger fireAt() {
		Trigger trigger = TriggerBuilder.newTrigger()
				...
				.withSchedule(cronSchedule("Fire at...", ApplicationConstant.CRON_EXPRESSION_TASK1))
				.build();
		return trigger;
	}
